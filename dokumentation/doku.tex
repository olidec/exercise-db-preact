...
\lstset{
    ...
    commentstyle=\color{green!60!black}, % Stil für Kommentare (z.B. grünlich)
    literate=
    *{0}{{{\color{red}0}}}{1}           % Zahlen in Rot
     ...
     {8}{{{\color{red}8}}}{1}
     {9}{{{\color{red}9}}}{1}
     {=>}{{{\color{blue}=>}}}{2},       % Operatoren hervorheben
}
...
\begin{itemize}
  ...
  \item \texttt{authorId}: Fremdschlüssel, der den Benutzer referenziert, der die Aufgabe erstellt hat.
   \item \texttt{author}: Beziehung zum Benutzer, der die Aufgabe erstellt hat. Diese Beziehung ist eine \texttt{1:n}-Beziehung, da ein Benutzer mehrere Aufgaben erstellen kann.
