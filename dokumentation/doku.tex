...
useEffect() für Unterkategorien: Diese Funktion sucht die Unterkategorien der ausgewählten Kategorie und speichert diese in subcategories und zwar jedes Mal, wenn dich selectedCategory oder categories ändert (Seiteneffekt). Ob sich categories ändert, würd nur beim ersten redndern der Seite überprüft, da bei der ersten useEffect() Funktion das Array leer blieb. 
