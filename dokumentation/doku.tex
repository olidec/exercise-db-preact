...
\bibitem{site:webdev} {\em Web Dev Simplified} Youtube Channel, 2018- (\url{https://www.youtube.com/@WebDevSimplified})

\bibitem{site:prisma} Prisma Data, Inc. {\em Prisma/docs} 2024 (\url{https://www.prisma.io/docs})

\bibitem{site:js} Mozilla {\em JavaScript Dokumentation} 2024 (\url{https://developer.mozilla.org/en-US/docs/Web/JavaScript})

\bibitem{site:preact} Preact {\em Preact Dokumentation} 2024 (\url{https://preactjs.com/})

\bibitem{site:pure} Pure CSS {\em Pure CSS Dokumentation} 2024 (\url{https://pure-css.github.io/})
