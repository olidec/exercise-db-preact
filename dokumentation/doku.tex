...
\item Suchergebnisse (SearchCard):
Komponenten für die Anzeige von Suchergebnissen, die eine einzelne Aufgabe darstellen mit der Möglichkeit die Aufgabe zum Warenkorb hinzuzufügen bzw. aus dem Warenkorb zu löschen, die Details der Aufgabe anzeigen zu lassen und, sofern man Autor der Aufgabe ist, die Aufgabe zu bearbeiten.
...
\item Aufgabe in Warenkorb (WarenCard)
...
Die einzelnen Aufgaben (WarenCard) werden in den Warenkorb gemappt und über einen Button können alle Aufgabe im Warenkorb heruntergeladen werden.


\item Aufgabendetails (Exercise Details):

Eine Detailansicht (AufgDetails) für jede Aufgabe, die Informationen wie Aufgabentext, Lösung und Kategoriezugehörigkeit enthält. Benutzer können Aufgaben in den Warenkorb legen.
